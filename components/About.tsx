...
const About:React.FC = () => {
  return (
    <>
      <div id='about' className='w-full flex flex-col items-center justify-evenly py-8 shadow-[inset_0px_2px_5px_rgba(255,255,255,0.5)] '>
      <div className='p-10 mb-5 w-full shadow'>
             <h2 className='font-extrabold text-4xl text-text2 tracking-widest mb-8 text-center' >About Me</h2>
             <p className='text-text1 tracking-wider leading-10 text-center'>Hello! I&apos;m <strong>Raju Mudavath</strong>, a passionate Frontend Developer with a knack for crafting sleek, responsive websites using JavaScript, TailwindCSS, and ReactJS. With hands-on experience in Next.js, Redux, and a solid backend foundation in Node.js, Express.js, and MongoDB, I bring a full-stack perspective to every project. Let&apos;s build something amazing together!.</p>
      </div>
      <div className='w-full flex md:flex flex-col md:flex-row items-center justify-center'>
        <div className='w-[90%] md:w-[40%] flex flex-col items-center justify-center shadow -mt-20 mb-6'>
            ...
            <button className="bg-white font-bold px-6 py-3 rounded-md w-[90%] shadow-xl tracking-widest text-xl ">
            <Link href='https://resume.io/r/kpSyznSzv' target='_blank'>
              Download Resume
            </Link>
            </button> 
        </div>
           <div className='w-[90%] md:w-[50%] rounded-xl shadow-2xl bg-black border border-text3'>
           <h2 className='font-bold text-center text-3xl text-text3 py-3 tracking-widest '>Personal Information</h2>
           <hr/>
            <ul className='text-text3 tracking-wider w-full'>
