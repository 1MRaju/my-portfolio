...
const About:React.FC = () => {
  return (
      ...
      <div className='p-10 mb-5 w-[90vw] shadow'>
             <h2 className='font-extrabold text-4xl text-text2 tracking-widest mb-8 text-center' >About Me</h2>
             <p className='text-text1 tracking-wider leading-6 text-center text-sm font-thin'>Hello! I&apos;m <strong>Raju Mudavath</strong>, a passionate Frontend Developer with a knack for crafting sleek, responsive websites using JavaScript, TailwindCSS, and ReactJS. With hands-on experience in Next.js, Redux, and a solid backend foundation in Node.js, Express.js, and MongoDB, I bring a full-stack perspective to every project. Let&apos;s build something amazing together!.</p>
      </div>
